...
<h3 style="text-align: center">ADD Mobile Company</h3>
    <div class="container py-5">
    
    <form name="frm" method="post" action="companymobile">
           ...
           <div class="col-sm-4">
           <input type="text" class="form-control" name="op" autocomplete="off" placeholder="Enter Number" required>
           </div>
           </div>
